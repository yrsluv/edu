...
export default {
    ...
    // cacheDirectory: "C:\\Users\\yrslv\\AppData\\Local\\Temp\\jest",
    ...
    // Setting this value to "fake" allows the use of fake
    // timers for functions such as "setTimeout"
    // timers: "real",
    ...
    // An array of regexp pattern strings that are matched
    // against all modules before the module loader
